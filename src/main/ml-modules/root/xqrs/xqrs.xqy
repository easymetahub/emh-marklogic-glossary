...
(: Last Sync - Fri Nov 29 14:17:52 EST 2019 :)
...
import module namespace xqrs2openapi = "http://xqdoc.org/library/xqrs/xqdoc/openapi" 
  at "/openapi/xqrs2xqdoc2openapi-lib.xqy";
import module namespace services2openapi = "http://xqdoc.org/library/services/xqdoc/openapi" 
  at "/openapi/services2xqdoc2openapi-lib.xqy";
import module namespace rxq2openapi = "http://xqdoc.org/library/rxq/xqdoc/openapi" 
  at "/openapi/rxq2xqdoc2openapi-lib.xqy";
import module namespace example = "http://www.example.org/example" 
  at "/example.xqy";
import module namespace gb = "http://www.xmllondon.com/guestbook" 
  at "/example-guestbook.xqy";
import module namespace emh-search = "http://www.easymetahub.com/xqrs/search" 
  at "/modules/search-xqrs.xqy";
import module namespace emh-upload = "http://www.easymetahub.com/xqrs/upload" 
  at "/modules/upload-xqrs.xqy";
import module namespace xqrs-functions = "http://xmllondon.com/xquery/xqrs-functions" 
  at "/xqrs/optional-libraries/xqrs-functions.xq";
import module namespace session = "http://xmllondon.com/xquery/session" 
  at "/xqrs/optional-libraries/session.xq";
import module namespace tx = "http://xmllondon.com/xquery/transaction" 
  at "/xqrs/optional-libraries/transaction.xq";
import module namespace rest-1 = "http://exquery.org/ns/restxq" 
  at "/xqrs/optional-libraries/restxq-function-module.xq";
(: Import RESTXQ Modules - finish :)
