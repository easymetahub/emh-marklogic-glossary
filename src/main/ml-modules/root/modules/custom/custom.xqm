    ...
    return
        object-node {
            ...
            'concept' : object-node {
                            ...
                            'definition' : array-node { for $definition in $concept/skos:definition return emhjson:concept-value($definition) },
...
(: This is an example of adding a grid of data to the result item.
            'grid' : object-node {
                        'columns' : array-node { ('Header', 'Value') },
                        'rows' : array-node {
                                    object-node {
                                        'Header' : 'Header One',
                                        'Value' : 'Value One'
            ...
            xdmp:document-insert(
                ...
                <options xmlns="xdmp:document-insert">  
                    ...
                    <permissions>{(
                        ...
                        xdmp:permission("emh-glossary-reader", "read"), 
                        xdmp:permission("emh-glossary-writer", "update")
                    )}</permissions>
                    <quality>10</quality>
                </options>
            )
